	...
	) : SV_Target
{
				...
				MMDLIT_CLIP_CUTOFF(alphaRef, 0.01);
			#else
				MMDLIT_CLIP_CUTOFF(alpha, _Cutoff);
			#endif
		#else
			// Always use AlphaTest.(Even if _ALPHATEST_ON is not defined.)
			MMDLIT_CLIP_FAST_CUTOFF(1.0, _Cutoff);
		#endif
